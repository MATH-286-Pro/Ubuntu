...
- [ ] [MGT-418 Convex Optimization]
  ...
  - [ ] Exercise
- [x] [CS-433 Machine Learning]
  - [x] Lecture.8.1 神经网络-反向传播
  - [x] Lecture.8.2 卷积网络 CNN
  - [x] Exercise.8 Pytorch 神经网络搭建
  
## 第9周任务
- [x] [MICRO-507 Legged Robots] 
  - [x] Presentation
  - [x] Project 2 完成一次 RL 训练
- [ ] [ME-427 Model Predictive Control]
  - [ ] Lecture.9 显式 MPC (加快计算时间)
  - [ ] Exercise.9
- [ ] [ME-425 Networked Control System]
  - [x] Lecture 矩阵次方收敛
  - [ ] Exercise
- [ ] [MGT-418 Convex Optimization]
  ...
  - [x] Project 2
- [ ] [CS-433 Machine Learning]
  - [x] Lecture.9.1 Transformer (重点：注意力机制)
  - [ ] Lecture.9.2 对抗性机器学习
  - [x] Exercise.9 对抗性机器学习
...
- [ ] [ME-427 Model Predictive Control]
  ...
  - [ ] Exercise.
- [ ] [ME-425 Networked Control System]
  - [x] Lecture.10 图论+一致性+收敛 
  - [ ] Exercise
- [ ] [MGT-418 Convex Optimization]
  - [ ] Lecture 
  - [ ] Exercise
- [x] [CS-433 Machine Learning]
  - [x] Lecture.10.1 机器学习的公平性
  - [x] Lecture.10.2 无监督学习
  - [x] Exercise.10
